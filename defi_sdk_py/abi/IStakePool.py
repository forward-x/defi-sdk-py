...
class IStakePool:
    ...
    def settleInterval(self, ):
        return self.contract.functions.settleInterval()

    def settlePeriod(self, ):
        return self.contract.functions.settlePeriod()
